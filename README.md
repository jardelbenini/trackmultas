...
**Etapa 4:**
Na quarta etapa do projeto foi implementado o módulo de Controle de Multas.
...
- Edição de multas
- Exclusão de multas
- Visualização dos detalhes da multa
- Relacionamento da multa com motorista, veículo, órgão, motivo da infração, responsabilidade, status do motorista, status de andamento e status de pagamento
- Campo de tratativa para registrar observações sobre a multa

Nesta etapa ainda não foram implementados dashboard, relatórios, gráficos ou segunda multa por não indicação.
