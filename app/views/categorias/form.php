                ...
                <div class="card-body p-4">
                    ...
                    <form action="<?php echo $actionUrl; ?>" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nome" name="nome" value="<?php echo isset($categoria['nome']) ? htmlspecialchars($categoria['nome']) : ''; ?>" required oninput="this.value = this.value.toUpperCase()">
                        </div>
