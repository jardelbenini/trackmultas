<div class="container-fluid px-4 py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo BASE_URL; ?>index.php?controller=status_pagamento&action=create" class="btn btn-primary">
                            ...
                            <?php foreach ($status_pagamento as $item): ?>
                                <tr>
                                    ...
                                    <td class="text-center text-nowrap">
                                        ...
                                        <a href="<?php echo BASE_URL; ?>index.php?controller=status_pagamento&action=delete&id=<?php echo $item['id']; ?>" class="btn btn-sm btn-outline-danger" title="Excluir" onclick="return confirm('Tem certeza que deseja excluir?');">
